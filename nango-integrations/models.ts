...
import type { ApiEndUser, DBSyncConfig, DBTeam, GetPublicIntegration, HTTP_METHOD, PostPublicTrigger, RunnerFlags } from '@nangohq/types';
...
export const NangoFlows = [
  {
    "providerConfigKey": "limitless-integration",
    "syncs": [
      {
        "name": "fetch-lifelogs",
        "type": "sync",
        "description": "Fetches Lifelog entries from the Limitless API.\nDetails: full sync, returns list of lifelogs based on specified parameters.",
        "sync_type": "full",
        "usedModels": [
          "LifelogList"
        ],
      ...
      {
        "name": "fetch-lifelog-by-id",
        "type": "sync",
        "description": "Fetches a specific Lifelog entry by ID from the Limitless API.",
        "sync_type": "full",
        "usedModels": [
          "LifelogSingle",
          "LifelogBase"
